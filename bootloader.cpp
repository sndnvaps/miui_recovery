...
static int get_bootloader_message_mtd(struct bootloader_message *out, const Volume_* v);
static int set_bootloader_message_mtd(const struct bootloader_message *in, const Volume_* v);
static int get_bootloader_message_block(struct bootloader_message *out, const Volume_* v);
static int set_bootloader_message_block(const struct bootloader_message *in, const Volume_* v);

int get_bootloader_message(struct bootloader_message *out) {
    Volume_* v = volume_for_path("/misc");
    if (v == NULL) {
